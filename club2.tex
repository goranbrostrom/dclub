...
utgång mot svaga handen). Svaga handen priffar genom att bjuda \hj{2} eller
\NT{2} och passa på svaret. Starka handen bjuder något annat eller, med
hjärterstöd, \NT{2} och \hj{3} på svaret. 

\section{\kl{1} -- \hj{2}}

Fyrkorts spader och 5+ \emph{bra} lågfärg, 9--15 hp (högst invit till
utgång mot svaga handen). Svaga handen priffar genom att bjuda \spa{2} eller
\NT{2} och passa på svaret. Starka handen bjuder något annat eller, med
spaderstöd, \NT{2} och \spa{3} på svaret. 
