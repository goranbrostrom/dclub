...
\subsection{\kl{2} - \ru{2}}
   \bbe
     ...
     %%\item[\NT{3}] Maximum, g{\aa}ende (minst) sexkorts kl{\"o}ver (finns knappt!).
   \ebe
...
\bbe
    \item[\kl{3}] minimum,
\bbe
\item[--\ru{3}] utgångskrävande fördelningsfråga;  \hj{3} visar \ford{4}{4}{1}{4} och
  \spa{3} \ford{4}{4}{0}{5} 
Sedan
är \ru{4} och \hj{4} på \spa{3} \emph{överföring} (för att kunna både bestämma trumf
och slaminvitera). 
 \item[--annat] Naturligt krav till utgång.
\ebe
    \item[\ru{3}] maximum, \ford{4}{4}{1}{4},
    \item[\hj{3}] maximum, \ford{4}{4}{0}{5},
\ebe
...
fastställas med 
kravtempo (dvs efter \ho{3}) används \ru{4}/\hj{4} som överföring. \emph{Höjning}
till \ho{4} 
...
\kl{4} ber öppnaren att överföra till sin färg, medan \ru{4} ber honom
bjuda den.
