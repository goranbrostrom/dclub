...
\bbe
   ...
   \item[--\hj{1}] 9+ hp, ``balanserad'', förnekar femkorts högfärg. Se
     också svaret \NT{2}. 
...
\bbe
\item[\hj{2}] 15+ hp, balanserad eller marmic med singelspader, högst
  trekortsspader. Sh bjuder 
  ``naturligt'', öppnarens \hj{3} är sedan naturligt, minst femkortsfärg.
\item[\spa{2}] 9--11 hp, 2--3 spader. Sangsystemet.
\item[\NT{2}] 15+ hp, fyrkortsstöd (tre kan duga i undantagsfall).
  \spa{3}] 9--11 hp, 4--5-stöd. Sangsystemet.
\item[Hopp i ny färg] 15+ hp, singel och stöd.    
