...
\bbe
\item[D] Spader
\item[\spa{1}] En typ av balanserad (8-11, 15+, bjud \NT{1}).
...
\bbe
\item[Dubbelt] En typ av balanserad (8-11, 15+, bjud \NT{1}).
\item[\NT{1}] 12--14 hp, balanserad (med håll), exakt trekortsstöd.
\item[\kl{2}] Enkelhöjning, trestöd, 7-11 hp.
\item[\ru{2}] Skräphöjning.
\item[\hj{2}] Spader.
...
\bbe
\item[D] En typ av balanserad (8-11, 15+, bjud \NT{1}).
\item[\NT{1}] 12--14 hp, balanserad (med håll), exakt trekortsstöd.
